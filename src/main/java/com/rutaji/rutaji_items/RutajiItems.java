package com.rutaji.rutaji_items;
...
@Mod(RutajiItems.MOD_ID)
public class RutajiItems
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "rutaji_items";
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        {
            event.accept(ModBlocks.BIG_SPONGE);
        }
    }
